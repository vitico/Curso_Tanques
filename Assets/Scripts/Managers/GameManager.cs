...
public class GameManager : MonoBehaviour
{
    ...
    private string EndMessage()
    {
        ...
        for (int i = 0; i < m_Tanks.Length; i++)
        {
            message += m_Tanks[i].m_ColoredPlayerText + ": " + m_Tanks[i].m_Wins + " PUNTOS\n";
        }

        if (m_GameWinner != null)
            message = m_GameWinner.m_ColoredPlayerText + " GANA EL JUEGO! CON PUNTUACION: " + m_GameWinner.m_Wins;
